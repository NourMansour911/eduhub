...
### RAG Node
Wraps the RAG subgraph. Serializes `previous_steps_outputs` (last 3 turns from Redis) and passes them in. Returns `retrieved_context`, `run_step_outputs`, and RAG status fields. See [RAG_README](agents/rag/RAG_README.md) for full details.
